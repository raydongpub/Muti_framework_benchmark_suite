...
/* ---------------- method closures -------------- */
    ...
    struct Closure_Grid::pauseForLB_2_closure : public SDAG::Closure {
  ...
  implP|impl_cnt_src;
    ...
    struct Closure_Grid::input_pos_shr_11_closure : public SDAG::Closure {
      int c_num;
      float *src;
      ...
      input_pos_shr_11_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      input_pos_shr_11_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|impl_cnt_src;
      ...
      virtual ~input_pos_shr_11_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(input_pos_shr_11_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Main::resumeIter(CkReductionMsg* impl_msg)
{
  ...
  else CkSendMsg(CkIndex_Main::idx_resumeIter_CkReductionMsg(), impl_msg, &ckGetChareID(),0);
}
...
void input_pos_shr(int c_num, const float *src);
...
void CProxyElement_Grid::pauseForLB(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg();
  ...
  ckSend(impl_amsg, CkIndex_Grid::idx_pauseForLB_void(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void input_pos_shr(int c_num, const float *src);
 */

void CProxyElement_Grid::input_pos_shr(int c_num, const float *src, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: int c_num, const float *src
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Grid::idx_input_pos_shr_marshall11(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Grid::pauseForLB(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Grid::idx_pauseForLB_void(),0);
}

// Entry point registration function

int CkIndex_Grid::reg_pauseForLB_void() {
...
void CkIndex_Grid::_call_pauseForLB_void(void* impl_msg, void* impl_obj_void)
{
  Grid* impl_obj = static_cast<Grid *>(impl_obj_void);
  CkFreeSysMsg(impl_msg);
  impl_obj->pauseForLB();
}
PUPable_def(SINGLE_ARG(Closure_Grid::pauseForLB_2_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Grid::input_pos_shr(int c_num, const float *src, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: int c_num, const float *src
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Grid::idx_input_pos_shr_marshall11(),0);
}

// Entry point registration function

int CkIndex_Grid::reg_input_pos_shr_marshall11() {
  int epidx = CkRegisterEp("input_pos_shr(int c_num, const float *src)",
      _call_input_pos_shr_marshall11, CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_input_pos_shr_marshall11);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_input_pos_shr_marshall11);

  return epidx;
}


void CkIndex_Grid::_call_input_pos_shr_marshall11(void* impl_msg, void* impl_obj_void)
{
  Grid* impl_obj = static_cast<Grid *>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  PUP::fromMem implP(impl_buf);
  Closure_Grid::input_pos_shr_11_closure* genClosure = new Closure_Grid::input_pos_shr_11_closure();
  implP|genClosure->c_num;
  int impl_off_src, impl_cnt_src; 
  implP|impl_off_src;
  implP|impl_cnt_src;
  ...
  genClosure->_impl_marshall = impl_msg_typed;
  CmiReference(UsrToEnv(genClosure->_impl_marshall));
  impl_obj->input_pos_shr(genClosure);
  genClosure->deref();
}

int CkIndex_Grid::_callmarshall_input_pos_shr_marshall11(char* impl_buf, void* impl_obj_void) {
  Grid* impl_obj = static_cast< Grid *>(impl_obj_void);
  PUP::fromMem implP(impl_buf);
  Closure_Grid::input_pos_shr_11_closure* genClosure = new Closure_Grid::input_pos_shr_11_closure();
  implP|genClosure->c_num;
...
void CkIndex_Grid::_marshallmessagepup_input_pos_shr_marshall11(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: int c_num, const float *src*/
  PUP::fromMem implP(impl_buf);
...
PUPable_def(SINGLE_ARG(Closure_Grid::input_pos_shr_11_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxySection_Grid::pauseForLB(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
...
void CProxySection_Grid::input_pos_shr(int c_num, const float *src, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: int c_num, const float *src
  int impl_off=0;
...
void CkIndex_Grid::__register(const char *s, size_t size) {
  ...
  // REG: void input_pos_shr(int c_num, const float *src);
  idx_input_pos_shr_marshall11();
...
SDAG::Continuation* Grid::_when_1(Closure_Grid::pgmrunloop_7_closure* gen0) {
  ...
  if (buf0) {
    __dep->removeMessage(buf0);
    _atomic_4(gen0, static_cast<Closure_Grid::input_pos_shr_11_closure*>(buf0->cl));
    delete buf0;
    return 0;
  } else {
...
#ifndef CK_TEMPLATES_ONLY
void Grid::_when_1_end(Closure_Grid::pgmrunloop_7_closure* gen0, Closure_Grid::input_pos_shr_11_closure* gen1) {
  _slist_4_end(gen0);
}
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
void Grid::_atomic_4(Closure_Grid::pgmrunloop_7_closure* gen0, Closure_Grid::input_pos_shr_11_closure* gen1) {
...
#endif /* CK_TEMPLATES_ONLY */
#ifndef CK_TEMPLATES_ONLY
void Grid::input_pos_shr(int c_num, float *src){
  Closure_Grid::input_pos_shr_11_closure* genClosure = new Closure_Grid::input_pos_shr_11_closure();
  genClosure->getP0() = c_num;
  genClosure->getP1() = src;
  input_pos_shr(genClosure);
  genClosure->deref();
}

#endif /* CK_TEMPLATES_ONLY */
#ifndef CK_TEMPLATES_ONLY
void Grid::input_pos_shr(Closure_Grid::input_pos_shr_11_closure* genClosure){
  if (!__dep.get()) _sdag_init();
...
void Grid::__sdag_register() { // Potentially missing Grid_SDAG_CODE in your class definition?
  ...
  PUPable_reg(SINGLE_ARG(Closure_Grid::pauseForLB_2_closure));
  ...
  PUPable_reg(SINGLE_ARG(Closure_Grid::input_pos_shr_11_closure));
  PUPable_reg(SINGLE_ARG(Closure_Grid::pauseForLB_2_closure));
  PUPable_reg(SINGLE_ARG(Closure_Grid::SendInput_3_closure));
  PUPable_reg(SINGLE_ARG(Closure_Grid::SendPost_4_closure));
  PUPable_reg(SINGLE_ARG(Closure_Grid::SendLoop_5_closure));
