...
class CkIndex_Grid:public CkIndex_ArrayElement{
  public:
    ...
    inline static int idx_pauseForLB(void (Grid::*)() ) {
    ...
    /* DECLS: void input_pos_shr(int c_num, const float *src);
     */
    // Entry point registration at startup
    
    static int reg_input_pos_shr_marshall11();
    // Entry point index lookup
    
    inline static int idx_input_pos_shr_marshall11() {
      static int epidx = reg_input_pos_shr_marshall11();
      return epidx;
    }

    
    inline static int idx_input_pos_shr(void (Grid::*)(int c_num, const float *src) ) {
      return idx_input_pos_shr_marshall11();
    }


    
    static int input_pos_shr(int c_num, const float *src) { return idx_input_pos_shr_marshall11(); }
    
    static void _call_input_pos_shr_marshall11(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_input_pos_shr_marshall11(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_input_pos_shr_marshall11(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_input_pos_shr_marshall11(PUP::er &p,void *msg);
 ...
 */
    ...
    void input_pos_shr(int c_num, const float *src, const CkEntryOptions *impl_e_opts=NULL) ;
...
private:                                                                       \
  ...
  void _when_1_end(Closure_Grid::pgmrunloop_7_closure* gen0, Closure_Grid::input_pos_shr_11_closure* gen1);\
  void _atomic_4(Closure_Grid::pgmrunloop_7_closure* gen0, Closure_Grid::input_pos_shr_11_closure* gen1);\
public:                                                                        \
...
public:                                                                        \
  ...
  void input_pos_shr(Closure_Grid::input_pos_shr_11_closure* genClosure);      \
  void input_pos_shr(int c_num, float *src);                                   \
...
class Closure_Grid {
  public:
    ...
    struct input_pos_shr_11_closure;
