#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-cct_2_64
#SBATCH -o oshm-cct_2_64.o%j
#SBATCH -e oshm-cct_2_64.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 64 --oversubscribe --hostfile host2_64 -x CUDA_VISIBLE_DEVICES=0,1,2,3 circuitcuda -l 10 -p 2432 -n 100 -w 150 -b 16 -t 256 
