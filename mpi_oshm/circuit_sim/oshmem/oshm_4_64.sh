#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-cct_4_64
#SBATCH -o oshm-cct_4_64.o%j
#SBATCH -e oshm-cct_4_64.e%j
#SBATCH -p gpu3 
#SBATCH -N 4 
...
time mpirun -np 64 --oversubscribe --hostfile host4_64 -x CUDA_VISIBLE_DEVICES=0,1,2,3 circuitcuda -l 10 -p 2432 -n 100 -w 150 -b 16 -t 256 
