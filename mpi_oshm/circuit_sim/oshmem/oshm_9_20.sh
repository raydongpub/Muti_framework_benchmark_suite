#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-cct_9_20
#SBATCH -o oshm-cct_9_20.o%j
#SBATCH -e oshm-cct_9_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 20 --oversubscribe --hostfile host9_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 circuitcuda -l 10 -p 2400 -n 100 -w 150 -b 16 -t 256 
