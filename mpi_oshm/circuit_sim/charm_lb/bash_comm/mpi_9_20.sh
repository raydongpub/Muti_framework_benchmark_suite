#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-circuit_sim_9_20
#SBATCH -o charm-circuit_sim_9_20.o%j
#SBATCH -e charm-circuit_sim_9_20.e%j
...
#time charmrun circuit_sim 10080 10080 5 5 20 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-circuit_sim-ntwe +p20 ++mpiexec
#--ntasks-per-core=20 
