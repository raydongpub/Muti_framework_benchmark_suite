#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-circuit_simnlb_9_64
#SBATCH -o charm-circuit_simnlb_9_64.o%j
#SBATCH -e charm-circuit_simnlb_9_64.e%j
...
#time charmrun circuit_sim 10080 10080 5 5 64 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-circuit_simnlb-ntwe +p64 ++mpiexec
#--ntasks-per-core=64 
