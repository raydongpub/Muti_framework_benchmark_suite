#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-nb_4_36
#SBATCH -o oshm-nb_4_36.o%j
#SBATCH -e oshm-nb_4_36.e%j
#SBATCH -p gpu3 
#SBATCH -N 4 
...
time mpirun -np 32 --hostfile host4_32 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nb_oshmcuda -c oshm1200k.conf -b 64 -t 256 
