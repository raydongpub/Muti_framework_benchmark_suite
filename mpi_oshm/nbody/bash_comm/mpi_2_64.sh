#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-nb_2_64
#SBATCH -o mpi-nb_2_64.o%j
#SBATCH -e mpi-nb_2_64.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 64 --oversubscribe --hostfile host2_64 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nb_mpicuda -c mpi1200k.conf -b 64 -t 256 
