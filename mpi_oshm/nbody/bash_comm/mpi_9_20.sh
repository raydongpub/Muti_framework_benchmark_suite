#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-nb_9_20
#SBATCH -o mpi-nb_9_20.o%j
#SBATCH -e mpi-nb_9_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 20 --hostfile host9_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nb_mpicuda -c mpi1200k.conf -b 64 -t 256 
