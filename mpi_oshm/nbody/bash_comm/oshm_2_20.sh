#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-nb_2_20
#SBATCH -o oshm-nb_2_20.o%j
#SBATCH -e oshm-nb_2_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 20 --oversubscribe --hostfile host2_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nb_oshmcuda -c oshm1200k.conf -b 64 -t 256
