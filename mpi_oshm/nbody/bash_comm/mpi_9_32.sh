#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-nb_9_32
#SBATCH -o mpi-nb_9_32.o%j
#SBATCH -e mpi-nb_9_32.e%j
#SBATCH -p gpu3 
#SBATCH -N 9 
...
time mpirun -np 32 --hostfile host9_32 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nb_mpicuda -c mpi1200k.conf -b 64 -t 256 
