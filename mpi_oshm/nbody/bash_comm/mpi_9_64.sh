#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-nb_9_64
#SBATCH -o mpi-nb_9_64.o%j
#SBATCH -e mpi-nb_9_64.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 64 --oversubscribe --hostfile host9_64 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nb_mpicuda -c mpi1200k.conf -b 64 -t 256 
...
#time mpirun -np 49 --hostfile host109 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nb_mpicuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
