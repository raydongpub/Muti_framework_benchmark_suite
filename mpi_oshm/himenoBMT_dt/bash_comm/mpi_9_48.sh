#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-himeno_9_48
#SBATCH -o mpi-himeno_9_48.o%j
#SBATCH -e mpi-himeno_9_48.e%j
#SBATCH -p gpu3 
#SBATCH -N 9 
...
time mpirun -np 48 --oversubscribe --hostfile host9_48 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_mpicuda -pe 4 4 3 -ds xl -b 16 -t 64
...
#time mpirun -np 49 --hostfile host109 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_mpicuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
