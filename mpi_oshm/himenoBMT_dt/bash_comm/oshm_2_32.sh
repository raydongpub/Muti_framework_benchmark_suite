#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-himeno_2_32
#SBATCH -o oshm-himeno_2_32.o%j
#SBATCH -e oshm-himeno_2_32.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 32 --hostfile host2_32 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_oshmcuda -pe 4 4 2 -ds xl -b 16 -t 64
