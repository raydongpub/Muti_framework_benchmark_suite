#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-himeno_4_32
#SBATCH -o oshm-himeno_4_32.o%j
#SBATCH -e oshm-himeno_4_32.e%j
#SBATCH -p gpu3 
#SBATCH -N 4 
...
time mpirun -np 32 --hostfile host4_32 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_oshmcuda -pe 4 4 2 -ds xl -b 16 -t 64
