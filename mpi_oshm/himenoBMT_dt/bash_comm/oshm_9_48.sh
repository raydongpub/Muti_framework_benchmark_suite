#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-himeno_9_48
#SBATCH -o oshm-himeno_9_48.o%j
#SBATCH -e oshm-himeno_9_48.e%j
#SBATCH -p gpu3 
#SBATCH -N 9 
...
time mpirun -np 48 --oversubscribe --hostfile host9_48 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_oshmcuda -pe 4 4 3 -ds xl -b 16 -t 64
