#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-himeno_2_48
#SBATCH -o mpi-himeno_2_48.o%j
#SBATCH -e mpi-himeno_2_48.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 48 --oversubscribe --hostfile host2_48 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_mpicuda -pe 4 4 3 -ds xl -b 16 -t 64
