#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-himeno_4_20
#SBATCH -o oshm-himeno_4_20.o%j
#SBATCH -e oshm-himeno_4_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 4
...
time mpirun -np 20 --oversubscribe --hostfile host4_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_oshmcuda -pe 5 2 2 -ds xl -b 16 -t 64
