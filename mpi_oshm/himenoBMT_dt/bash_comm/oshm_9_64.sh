#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-himeno_9_64
#SBATCH -o oshm-himeno_9_64.o%j
#SBATCH -e oshm-himeno_9_64.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 64 --oversubscribe --hostfile host9_64 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_oshmcuda -pe 4 4 4 -ds xl -b 16 -t 64
...
#time mpirun -np 49 --hostfile host109 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_oshmcuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
