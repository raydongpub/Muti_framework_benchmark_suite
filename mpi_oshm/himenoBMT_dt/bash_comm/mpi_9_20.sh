#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-himeno_9_20
#SBATCH -o mpi-himeno_9_20.o%j
#SBATCH -e mpi-himeno_9_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 20 --hostfile host9_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_mpicuda -pe 5 2 2 -ds xl -b 16 -t 64
