#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-himeno_2_20
#SBATCH -o oshm-himeno_2_20.o%j
#SBATCH -e oshm-himeno_2_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 20 --oversubscribe --hostfile host2_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 bmt_oshmcuda -pe 5 2 2 -ds xl -b 16 -t 64
