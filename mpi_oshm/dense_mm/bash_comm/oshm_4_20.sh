#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-matmul_4_20
#SBATCH -o oshm-matmul_4_20.o%j
#SBATCH -e oshm-matmul_4_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 4
...
time mpirun -np 20 --hostfile host4_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_oshmcuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
