#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-matmul_9_20
#SBATCH -o oshm-matmul_9_20.o%j
#SBATCH -e oshm-matmul_9_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 20 --hostfile host9_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_oshmcuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
