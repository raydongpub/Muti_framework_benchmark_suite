#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-matmul_10_20
#SBATCH -o mpi-matmul_10_20.o%j
#SBATCH -e mpi-matmul_10_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 10
...
time mpirun -np 20 --hostfile host10_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_mpicuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
