#!/usr/bin/bash
#!/bin/sh
#SBATCH -J mpi-matmul_4_36
#SBATCH -o mpi-matmul_4_36.o%j
#SBATCH -e mpi-matmul_4_36.e%j
#SBATCH -p gpu3 
#SBATCH -N 4 
...
time mpirun -np 36 --hostfile host4_36 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_mpicuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset9972.nn -b 64 -t 128
