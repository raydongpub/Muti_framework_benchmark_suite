#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-matmul_9_64
#SBATCH -o oshm-matmul_9_64.o%j
#SBATCH -e oshm-matmul_9_64.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 64 --oversubscribe --hostfile host9_64 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_oshmcuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset9984.nn -b 64 -t 128
