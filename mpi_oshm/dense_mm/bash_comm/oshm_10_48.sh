#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-matmul_10_48
#SBATCH -o oshm-matmul_10_48.o%j
#SBATCH -e oshm-matmul_10_48.e%j
#SBATCH -p gpu3 
#SBATCH -N 10 
...
time mpirun -np 48 --oversubscribe --hostfile host10_48 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_oshmcuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset9984.nn -b 64 -t 128
