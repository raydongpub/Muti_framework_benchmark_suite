#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-matmul_2_36
#SBATCH -o oshm-matmul_2_36.o%j
#SBATCH -e oshm-matmul_2_36.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 36 --hostfile host2 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_oshmcuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset9972.nn -b 64 -t 128
