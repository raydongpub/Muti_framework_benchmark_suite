#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-matmul_2_20
#SBATCH -o oshm-matmul_2_20.o%j
#SBATCH -e oshm-matmul_2_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 20 --hostfile host2_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_oshmcuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
