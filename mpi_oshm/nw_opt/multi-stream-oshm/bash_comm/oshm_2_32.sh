#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-nw_2_32
#SBATCH -o oshm-nw_2_32.o%j
#SBATCH -e oshm-nw_2_32.e%j
#SBATCH -p gpu3 
#SBATCH -N 2 
...
time mpirun -np 32 --oversubscribe --hostfile host2_32 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nw-single-stream -ds 2 -l 1000 -n 4992 -b 64 -t 512 
