#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-nw_9_20
#SBATCH -o oshm-nw_9_20.o%j
#SBATCH -e oshm-nw_9_20.e%j
#SBATCH -p gpu3 
#SBATCH -N 9
...
time mpirun -np 20 --oversubscribe --hostfile host9_20 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nw-single-stream -ds 2 -l 1000 -n 5000 -b 64 -t 512 
