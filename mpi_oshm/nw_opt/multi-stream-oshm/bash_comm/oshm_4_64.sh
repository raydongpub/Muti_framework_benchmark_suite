#!/usr/bin/bash
#!/bin/sh
#SBATCH -J oshm-nw_4_64
#SBATCH -o oshm-nw_4_64.o%j
#SBATCH -e oshm-nw_4_64.e%j
#SBATCH -p gpu3 
#SBATCH -N 4 
...
time mpirun -np 64 --oversubscribe --hostfile host4_64 -x CUDA_VISIBLE_DEVICES=0,1,2,3 nw-single-stream -ds 2 -l 1000 -n 4992 -b 64 -t 512 
