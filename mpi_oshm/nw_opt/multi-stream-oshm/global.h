...
extern int DEBUG;
#if 0
extern char * sequence_set1[MAX_STREAM];
extern char * sequence_set2[MAX_STREAM];
extern unsigned int * pos1[MAX_STREAM];
extern unsigned int * pos2[MAX_STREAM];
extern unsigned int * pos_matrix[MAX_STREAM];
