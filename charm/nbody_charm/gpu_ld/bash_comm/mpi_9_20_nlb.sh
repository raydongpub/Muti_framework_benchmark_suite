#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nbodynlb_9_20
#SBATCH -o charm-nbodynlb_9_20.o%j
#SBATCH -e charm-nbodynlb_9_20.e%j
...
time charmrun nbody -c mpi.conf -s 20 +p20 ++mpiexec #+balancer RefineLB 
#time charmrun nbody 10080 10080 5 5 20 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nbodynlb-ntwe +p20 ++mpiexec
