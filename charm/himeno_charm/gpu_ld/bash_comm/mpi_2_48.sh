#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-matmul_2_48
#SBATCH -o charm-matmul_2_48.o%j
#SBATCH -e charm-matmul_2_48.e%j
#SBATCH -p gpu3 --gres=gpu:1 
#SBATCH -N 2 
#SBATCH -w "lewis4-r730-gpu3-node430, lewis4-r730-gpu3-node431"
#SBATCH -n 48 -m plane=20 --mem=100g
...
time charmrun --oversubscribe matmul 10045 10045 5 5 48 /home/rgcxc/data/workspace/benchmark/data_set/dset10045.nn ++nodegroup charm-matmul-fot +p48 ++mpiexec
