#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-himenonlb_9_32
#SBATCH -o charm-himenonlb_9_32.o%j
#SBATCH -e charm-himenonlb_9_32.e%j
...
time charmrun himeno -pe 4 4 2 -ds xl -c 32 +p32 ++mpiexec #+balancer RefineLB 
#time charmrun himeno 10080 10080 5 5 32 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-himenonlb-ntwe +p32 ++mpiexec
#time mpirun -np 32 --hostfile host9_32 -x CUDA_VISIBLE_DEVICES=0,1,2,3 mm_mpicuda -m /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn -b 64 -t 128
