#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-himenonlb_9_48
#SBATCH -o charm-himenonlb_9_48.o%j
#SBATCH -e charm-himenonlb_9_48.e%j
...
time charmrun himeno -pe 4 4 3 -ds xl -c 48 +p48 ++mpiexec #+balancer RefineLB 
#time charmrun himeno 10080 10080 5 5 48 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-himenonlb-ntwe +p48 ++mpiexec
#--ntasks-per-core=48 
