#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-himenonlb_9_20
#SBATCH -o charm-himenonlb_9_20.o%j
#SBATCH -e charm-himenonlb_9_20.e%j
...
time charmrun himeno -pe 5 2 2 -ds xl -c 20 +p20 ++mpiexec #+balancer RefineLB 
#time charmrun himeno 10080 10080 5 5 20 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-himenonlb-ntwe +p20 ++mpiexec
