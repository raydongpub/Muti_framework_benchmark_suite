#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-himeno_9_32
#SBATCH -o charm-himeno_9_32.o%j
#SBATCH -e charm-himeno_9_32.e%j
...
#time charmrun himeno 10080 10080 5 5 32 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-himeno-ntwe +p32 ++mpiexec
