#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-himenonlb_9_64
#SBATCH -o charm-himenonlb_9_64.o%j
#SBATCH -e charm-himenonlb_9_64.e%j
...
#time charmrun himeno 10080 10080 5 5 64 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-himenonlb-ntwe +p64 ++mpiexec
