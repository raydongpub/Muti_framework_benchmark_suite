#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nwnlb_9_32
#SBATCH -o charm-nwnlb_9_32.o%j
#SBATCH -e charm-nwnlb_9_32.e%j
...
time charmrun nw -l 1000 -n 5184 -f 18 -s 32 -b 64 -t 512 +p32 ++mpiexec #+balancer RefineLB 
#time charmrun nw 10080 10080 5 5 32 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nwnlb-ntwe +p32 ++mpiexec
