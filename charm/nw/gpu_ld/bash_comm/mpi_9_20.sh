#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nw_9_20
#SBATCH -o charm-nw_9_20.o%j
#SBATCH -e charm-nw_9_20.e%j
...
#time charmrun nw 10080 10080 5 5 20 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nw-ntwe +p20 ++mpiexec
