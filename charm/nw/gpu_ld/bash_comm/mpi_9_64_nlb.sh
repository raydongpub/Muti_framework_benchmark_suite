#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nwnlb_9_64
#SBATCH -o charm-nwnlb_9_64.o%j
#SBATCH -e charm-nwnlb_9_64.e%j
...
time charmrun nw -l 1000 -n 5120 -f 20 -s 64 -b 64 -t 512 +p64 ++mpiexec #+balancer RefineLB 
#time charmrun nw 10080 10080 5 5 64 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nw-ntwe +p64 ++mpiexec
