#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-matmul_9_64
#SBATCH -o charm-matmul_9_64.o%j
#SBATCH -e charm-matmul_9_64.e%j
...
time charmrun matmul 9984 9984 4 4 64 /home/rgcxc/data/workspace/benchmark/data_set/dset9984.nn +p64 ++mpiexec +balancer RefineLB
