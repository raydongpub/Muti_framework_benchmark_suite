#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-matmul_9_20
#SBATCH -o charm-matmul_9_20.o%j
#SBATCH -e charm-matmul_9_20.e%j
...
time charmrun matmul 10000 10000 5 5 20 /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn ++nodegroup charm-matmul-ntwe +p20 ++mpiexec +balancer RefineLB 
