...
time mpirun -np 20 --hostfile host5_20 --mca btl self,sm,tcp matmul 10000 10000 5 5 20 /home/rgu/workspace/ben_suit/data_set/dset10k.nn +balancer RefineLB >nps_result/charm_ld_5_20_10k.txt
