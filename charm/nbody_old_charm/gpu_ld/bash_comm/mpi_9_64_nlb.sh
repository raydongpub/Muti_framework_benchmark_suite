#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nbodynlb_9_64
#SBATCH -o charm-nbodynlb_9_64.o%j
#SBATCH -e charm-nbodynlb_9_64.e%j
...
time charmrun nbody -c mpi.conf -s 64 +p64 ++mpiexec #+balancer RefineLB 
#time charmrun nbody 10080 10080 5 5 64 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nbodynlb-ntwe +p64 ++mpiexec
