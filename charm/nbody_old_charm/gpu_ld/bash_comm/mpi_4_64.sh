#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nbody_4_64
#SBATCH -o charm-nbody_4_64.o%j
#SBATCH -e charm-nbody_4_64.e%j
#SBATCH -p gpu3 
...
time charmrun nbody -c mpi.conf -s 64 +p64 ++mpiexec
#time charmrun nbody 10000 10000 5 5 64 /home/rgcxc/data/workspace/benchmark/data_set/dset10k.nn ++nodegroup charm-nbody-twe +p64 ++mpiexec
