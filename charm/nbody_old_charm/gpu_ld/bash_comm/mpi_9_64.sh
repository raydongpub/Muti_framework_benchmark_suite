#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nbody_9_64
#SBATCH -o charm-nbody_9_64.o%j
#SBATCH -e charm-nbody_9_64.e%j
...
#time charmrun nbody 10080 10080 5 5 64 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nbody-ntwe +p64 ++mpiexec
