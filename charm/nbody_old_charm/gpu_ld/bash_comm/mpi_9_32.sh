#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nbody_9_32
#SBATCH -o charm-nbody_9_32.o%j
#SBATCH -e charm-nbody_9_32.e%j
...
#time charmrun nbody 10080 10080 5 5 32 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nbody-ntwe +p32 ++mpiexec
