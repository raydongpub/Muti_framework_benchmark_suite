#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nbodynlb_9_48
#SBATCH -o charm-nbodynlb_9_48.o%j
#SBATCH -e charm-nbodynlb_9_48.e%j
...
#time charmrun nbody 10080 10080 5 5 48 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nbodynlb-ntwe +p48 ++mpiexec
