#!/usr/bin/bash
#!/bin/sh
#SBATCH -J charm-nbodynlb_9_32
#SBATCH -o charm-nbodynlb_9_32.o%j
#SBATCH -e charm-nbodynlb_9_32.e%j
...
time charmrun nbody -c mpi.conf -s 32 +p32 ++mpiexec #+balancer RefineLB 
#time charmrun nbody 10080 10080 5 5 32 /home/rgcxc/data/workspace/benchmark/data_set/dset10080.nn ++nodegroup charm-nbodynlb-ntwe +p32 ++mpiexec
